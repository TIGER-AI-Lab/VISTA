...
max_img_seq_len=80000
max_txt_seq_len=8192
...
DATA_CONFIG_FILE="train/data_configs/idefics2/data_vista_idefics2.yaml"
OUTPUT_DIR="output/instruction_tuning"
if [ -z "$RUN_NAME" ]; then
    RUN_NAME="mantis_vista_data_sft_lr5e-7_f_24"
fi

export WANDB_API_KEY="<your wandb key>"
export WANDB_PROJECT="video_llm_idefics2_instruction_tuning"
