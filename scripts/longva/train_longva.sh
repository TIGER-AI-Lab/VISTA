...
DATA_CONFIG_FILE="train/data_configs/longva/data_vista_longva.yaml"
OUTPUT_DIR="output/instruction_tuning"
if [ -z "$RUN_NAME" ]; then
    RUN_NAME="longva_vista_data_sft_lr1e-7_f_64"
fi

export WANDB_API_KEY="<your wandb key>"
export WANDB_PROJECT="video_llm_longva_instruction_tuning"
