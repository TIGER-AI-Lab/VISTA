...
def load_model(model_args, training_args):
    ...
    processor = LongVAProcessor(image_processor, tokenizer, model_config=model.config)
    ...
    from models.longva.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_TOKEN
    set_default_image_token(DEFAULT_IMAGE_TOKEN)
    set_default_image_token_id(IMAGE_TOKEN_INDEX)
    set_default_video_token(DEFAULT_IMAGE_TOKEN)
    set_default_video_token_id(IMAGE_TOKEN_INDEX)
...
def main(
    ...
    data_args.model_patch_size = model.model.vision_tower.config.patch_size
    ...
    if training_args.do_train:
        ...
        processor.tokenizer.save_pretrained(final_checkpoint_dir)
