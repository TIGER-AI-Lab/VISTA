...
from train.data import load_data_from_config, set_ignore_index, set_default_image_token, set_default_video_token, set_default_image_token_id, set_default_video_token_id, Collator
...
def load_model(model_args, training_args):
    ...
    set_default_video_token(processor.tokenizer.decode(model.image_token_id))
    set_default_video_token_id(model.image_token_id)
