...
from eval.utils_msvd import MSVDDataset
...
def main(
    ...
    data_dir="/cpfs/data/user/weiming/datasets/MVSD/MSVD_Zero_Shot_QA/videos",
    json_path="/cpfs/data/user/weiming/datasets/MVSD/msvd_qa.json",
    num_frames=64,
    img_shortest_edge=256,
    img_longest_edge=480,
    max_img_seq_len=40000,
    do_resize=False,
    results_dir="./output/eval/msvd",
    overwrite=False,
    # generation config
    max_new_tokens=512,
    do_sample=False,
