...
from eval.utils_hrvideobench import HighresQADataset
...
def main(
    ...
    data_dir="/cpfs/data/user/weiming/datasets/VWI-EXP/highres_benchmark_videos",
    json_path="/cpfs/data/user/weiming/datasets/VWI-EXP/highres_benchmark_videos/highres_mcq_frames_with_category.jsonl",
    num_frames=64,
    img_shortest_edge=256,
    img_longest_edge=480,
    max_img_seq_len=40000,
    do_resize=False,
    results_dir="./output/eval/highres_qa",
    overwrite=False,
    # generation config
    max_new_tokens=512,
    do_sample=False,
