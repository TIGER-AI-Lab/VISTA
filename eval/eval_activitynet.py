...
from eval.utils_activitynet import ActivityNetDataset
...
def main(
    ...
    data_dir="/cpfs/data/user/weiming/datasets/ActivityNetQA/all_test",
    json_path="/cpfs/data/user/weiming/datasets/ActivityNetQA/activitynet_qa_test.json",
    num_frames=64,
    img_shortest_edge=256,
    img_longest_edge=480,
    max_img_seq_len=40000,
    do_resize=False,
    results_dir="./output/eval/activitynet",
    overwrite=False,
    # generation config
    max_new_tokens=512,
    do_sample=False,
