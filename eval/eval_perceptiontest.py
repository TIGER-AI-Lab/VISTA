...
from eval.utils_perceptiontest import PerceptionTestDataset
...
def main(
    ...
    data_dir="/cpfs/data/user/weiming/datasets/PerceptionTest_Val",
    num_frames=8,
    img_shortest_edge=256,
    img_longest_edge=480,
    max_img_seq_len=16500,
    do_resize=False,
    results_dir="./output/eval/perceptiontest",
    overwrite=False,
    # generation config
    max_new_tokens=512,
    do_sample=False,
