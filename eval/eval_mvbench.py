...
def main(
    ...
    model_name_or_path="/cpfs/data/user/weiming/repos/video-mamba/videomamba/videollm/output/instruction_tuning/Video-LLaVA-7B-hf/hq_it_data_sft_lr1e-5_f64_img20000_txt1024/checkpoint-2300",
    data_dir="/cpfs/data/user/weiming/datasets/MVBench",
    num_frames=8,
    img_shortest_edge=256,
    img_longest_edge=980,
