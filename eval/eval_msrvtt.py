...
from eval.utils_msrvtt import MSRVTTDataset
...
def main(
    ...
    data_dir="/cpfs/data/user/weiming/datasets/MSRVTT_Zero_Shot_QA/videos/all",
    json_path="/cpfs/data/user/weiming/datasets/MSRVTT_Zero_Shot_QA/msrvtt_qa.json",
    num_frames=64,
    img_shortest_edge=256,
    img_longest_edge=480,
    max_img_seq_len=40000,
    do_resize=False,
    results_dir="./output/eval/msrvtt",
    overwrite=False,
    # generation config
    max_new_tokens=512,
    do_sample=False,
