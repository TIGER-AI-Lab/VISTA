...
class PerceptionTestDataset(Dataset):
    def __init__(self, dataset_path: str, sample_config: dict):
        ...
        self.video_path = os.path.join(dataset_path, 'videos')
        self.sample_config = sample_config

        data_list = []
        df = read_parquet(osp.join(dataset_path, 'mc_question_val', 'validation-00000-of-00001.parquet'))
    ...
    def __getitem__(self, idx) -> dict:
        ...
        item['answer'] = chr(65+int(item["answer"]))
